...
class PortfolioAgentEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Handle duplicates during pivot
        pivoted = current_data.groupby(['Date', 'Ticker'])['Returns'].mean().reset_index()
        pivoted = pivoted.pivot(index='Date', columns='Ticker', values='Returns')
